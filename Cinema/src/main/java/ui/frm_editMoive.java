...
public class frm_editMoive extends JFrame {
	...
	public static void main(String[] args) {
		new frm_editMoive(movie).setVisible(true);
	}
	public frm_editMoive(Movie movie) {
		setSize(700,500);
		...
		btnChonAnh.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				frm_editMoive frame = new frm_editMoive(movie);
				frame.revalidate();
		        frame.repaint();
				setImg(linkImg);
				linkIMG = linkImg;
		...
		txtTenPhim.setText(movie.getTitle());
		txtThoiLuong.setText(movie.getDuration()+"");
		txtDaoDien.setText(movie.getDirector());
		txtGenre.setSelectedItem(movie.getGenre());
		txtNgay.setText(movie.getReleaseDate());
		lblImage.setIcon(new ImageIcon("src/main/java/imgs/"+movie.getImg()));
	}
